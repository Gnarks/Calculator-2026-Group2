 ...
 * It is used in the Calculator class to print arithmetic expressions in a human-readable format.
 *
 * @see Visitor
...
public class Printer extends Visitor{
    ...
    /* The StringBuilder that is used to build the string representation of an arithmetic expression */
     ...
     * @param notation The notation to be used for printing expressions (prefix, infix or postfix)
     */
    ...
    /** The visit method for Operation. Needs to handle the different notations (prefix, infix and postfix) and the different number of arguments that an operation can have.
     * It uses helper methods visitArgs and visitArgsInfix to handle the different notations.
    ...
    * @return The string representation of the expression that has been built by the visit methods
    */
